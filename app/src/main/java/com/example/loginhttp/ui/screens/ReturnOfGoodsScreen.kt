...
import com.example.loginhttp.model.ReturnOfGoodsItem
...
@Composable
fun ReturnOfGoodsScreen(
    selectedScreen: String = "Warehouse",
    onNavigate: (String) -> Unit = {},
) {
    val viewModel: ReturnOfGoodsViewModel = viewModel()
    ...
    Card(
        ...
        Row(
            ...
            Column(
                ...
                Text("Povrat robe: ${item.id}", fontSize = 18.sp, color = DeepNavy)
