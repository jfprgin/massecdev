        ...
        Column(
            ...
            if (isInSelectionMode) {
                SelectionToolbar(
                    ...
                    onSelectAll = { viewModel.selectAll(constCenters.map { it.id })},
                    actions = listOf(
            ...
            OutlinedTextField(
                ...
                placeholder = {
                    Text(
                        "Pretraži mjesta troškova (${constCenters.size})",
                        color = DarkGray,
                        fontSize = 18.sp
                    )
                },
